            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        ...
                        <!--begin::Form-->
                        <form class="form" action="{{route('admin.auth.check_login')}}" method="POST">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome Admin</h3>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form group-->
                            ...
                            <div class="pb-lg-0 pb-5">
                                <button type="submit"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Đăng
                                    nhập</button>
                                <button type="button"
                                    class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/social-icons/google.svg-->
