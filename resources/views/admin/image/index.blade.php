       ...
       <div class="card">
           <div class="card-header">
               <h1>Danh sách bài viết</h1>
                <form action="{{route('image.index')}}" id = "search_data" method="get">
                    @csrf
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-xl-2 mt-5 mt-lg-0">
                            <a type="button" href="{{route('image.create')}}" class="btn btn-success px-6 font-weight-bold">Thêm mới +</a>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    function getlist(){
        ...
        $.ajax({
            type:'GET',
            url:`{{route('image.indexAjax')}}?page=`+page+'&search_key='+search_key+'&status='+status+'&cat_id='+cat_id,
