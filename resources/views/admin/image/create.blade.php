                   ...
                   <div class="row">
                       <div class="col-7">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="caption" id="editor-ckeditor" class="form-control" placeholder="Nhập tiêu đề" aria-describedby="helpId">{{old('caption')?old('caption'):''}}</textarea>
                                @error('caption')
                       ...
                       <div class="form-group ">
                        ...
                        <div class="upload_image" style="height:330px">
                            @if(old('my_file'))
