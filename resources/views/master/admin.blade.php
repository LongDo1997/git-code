...
<head>
    ...
    <link href="{{url('/public')}}/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
    ...
    <!--end::Layout Themes-->
    <link rel="stylesheet" media="screen" href="{{url('/public')}}/assets/plugins/calender/jquery.calendar.css"/>
    <!-- begin summernot css -->
    <link rel="stylesheet" href="{{url('/public')}}/assets/plugins/summernote/summernote.min.css">
...
<body id="kt_body"
        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/General/User.svg-->
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="http://keenthemes.com/metronic" target="_blank"
                                class="text-dark-75 text-hover-primary">byQhaki</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Nav-->
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            <h3 class="font-weight-bold m-0">Quản trị
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('http://localhost:88/project_bakery/public/assets/media/users/300_21.jpg')"></div>
                    <i class="symbol-badge bg-success"></i>
                </div>
                <div class="d-flex flex-column">
                    <a href="#"
                        class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">@yield('tittle')</a>
                    ...
                    <div class="navi mt-2">
                            ...
                            <span class="navi-link p-0 pb-2">
                                <span class="navi-icon mr-1">
                                    <span class="svg-icon svg-icon-lg svg-icon-primary">
                                        <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/Communication/Mail-notification.svg-->
                        ...
                        <a href="{{url('admin/auth/logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                    </div>
                </div>
            </div>
            <!--end::Header-->
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-success">
                                    <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/General/Notification2.svg-->
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-warning">
                                    <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/Shopping/Chart-bar1.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-danger">
                                    <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/Files/Selected-file.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                        ...
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/Communication/Mail-opened.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="d-flex align-items-center justify-content-between py-8">
                    ...
                    <a href="#" class="symbol symbol-70 flex-shrink-0">
                        <img src="{{url('/public')}}/assets/media/stock-600x400/img-1.jpg" title="" alt="" />
                    </a>
                </div>
                <!--end::Item-->
            </div>
                            ...
                            <div class="dropdown dropdown-inline">
                                <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md"
                                    ...
                                    <span class="svg-icon svg-icon-lg">
                                        <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/Communication/Add-user.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div id="kt_scrolltop" class="scrolltop">
        <span class="svg-icon">
            <!--begin::Svg Icon | path:{{url('/public')}}/assets/media/svg/icons/Navigation/Up-2.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <polygon points="0 0 24 0 24 24 0 24" />
    ...
    <script src="{{url('/public')}}/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
    ...
    <script src="{{url('/public')}}/assets/js/pages/widgets.js"></script>
    <!--end::Page Scripts-->
    <!-- begin summernote -->
    <script src="{{url('/public')}}/assets/plugins/summernote/summernote.min.js"></script>
    <script src="{{url('/public')}}/assets/ckeditor/ckeditor.js"></script>
    <script>
    CKEDITOR.replace( 'editor-ckeditor' ,{
        filebrowserBrowseUrl : '{{url("/public")}}/filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
        filebrowserUploadUrl : '{{url("/public")}}/filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
        filebrowserImageBrowseUrl : '{{url("/public")}}/filemanager/dialog.php?type=1&editor=ckeditor&fldr='
    });
    CKEDITOR.replace( 'editor-ckeditor2' ,{
        filebrowserBrowseUrl : '{{url("/public")}}/filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
        filebrowserUploadUrl : '{{url("/public")}}/filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
        filebrowserImageBrowseUrl : '{{url("/public")}}/filemanager/dialog.php?type=1&editor=ckeditor&fldr='
    });
